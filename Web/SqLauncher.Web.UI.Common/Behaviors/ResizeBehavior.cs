...
//   ******************************************************************************
//   *
//   * File Name:   ResizeBehavior.cs
//   * Project: SqLauncher.Web.UI.Common
//   * Description: http://gallery.expression.microsoft.com/ResizeBehavior
//   * Created at 2012 03 08 11:29
//   * Modified at: 2012  03 08  11:29
// / ******************************************************************************/ 
...
namespace SqLauncher.Web.UI.Common.Behaviors
{
    public class ResizeBehavior : Behavior<FrameworkElement>
    {
        ...
        private ControlParts resizePart;
        ...
        [Category( "Size" ),
         Description(
             "Espose this event because when size is changed by bahavior the FrameworkElement.SizeChanged eventis not raised"
             )]
        ...
        {
            if ( isResizing ){
                resize( e.GetPosition( this.AssociatedObject ),
                        e.GetPosition( (FrameworkElement) this.AssociatedObject.Parent ) );
        ...
        private void AssociatedObject_MouseLeftButtonDown( object sender, MouseButtonEventArgs e )
        {
            ...
            if ( getResizePart( e.GetPosition( AssociatedObject ) )!=ControlParts.None ){
                e.Handled = true;    
            } //if
        }
        ...
        private void AssociatedObject_Loaded( object sender, RoutedEventArgs e )
        {
            ...
            if ( parent_resize_behavior == null ){
                ( this.AssociatedObject.Parent as FrameworkElement ).SizeChanged += ParentSizeChanged;
            }

            else{
                //attach to parent's resize behavior to notice size changes
                parent_resize_behavior.SizeChanged += ParentBehaviorSizeChanged;
            }
        }
        ...
        private void ParentBehaviorSizeChanged( object sender, EventArgs e )
        {
            this.checkParentBounds();
        }
        ...
        private void setRectangle( ControlParts part )
        {
            ...
            switch ( part ){
                ...
                case ControlParts.Bottom:
                    ...
                    rect.SetValue( Canvas.TopProperty,
                                   this.AssociatedObject.ActualHeight - this.DragSpace +
                ...
                case ControlParts.Right:
                    ...
                    rect.SetValue( Canvas.LeftProperty,
                                   this.AssociatedObject.ActualWidth - this.DragSpace +
        ...
        private void resize( Point insideMousePosition, Point parentMousePosition )
        {
        ...
        private void checkParentBounds()
        {
            if ( !this.StayInParent || this.AssociatedObject == null ){
                return;
            }
